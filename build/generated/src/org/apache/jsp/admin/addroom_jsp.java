...
ResultSet rs = null;
      ...
      out.write("             <li><a class=\"active\"  href=\"addroom.jsp\"><i class=\"fa fa-dashboard\"></i>Add Room</a></li>\n");
      ...
      out.write("                <div class=\"col-12 col-md-12 col-lg-12 text-center\"> <h1 class=\"page-header\">ADD  <small class=\"small-header\">ROOM</small></h1></div>   \n");
      out.write("                    <div class=\"row\">\n");
      ...
      out.write("                                    <h4 class=\"text-white roomhead\">Add Room</h4>\n");
      out.write("                                     </br>\n");
      out.write("                                       <div>\n");
      out.write("                                            <form action=\"addroom.jsp\" method=\"POST\">\n");
      out.write("                                                <div class=\"form-group formtext\">  \n");
      out.write("                                                    <label class=\"font-weight-bold\" for=\"roomid\"> Room Id:</label>\n");
      out.write("                                                    <input type=\"text\" class=\"form-control\"  name=\"roomid\">\n");
      out.write("                                                </div>                   \n");
      out.write("                                                <div class=\"form-group formtext\">\n");
      out.write("                                                    <label class=\"font-weight-bold\" for=\"title\">Type of Room :</label>\n");
      out.write("                                                       <select class=\"form-control setlen\" name=\"roomtype\">\n");
      ...
      out.write("                         \n");
      out.write("                                                <div class=\"form-group formtext\">\n");
      out.write("                                                    <label class=\"font-weight-bold\" for=\"title\" >Bedding Type :</label>\n");
      out.write("                                                          <select class=\"form-control setlen\" name=\"beddingtype\">\n");
      out.write("                                                              <option value selected ></option>\n");
      ...
      out.write("                                                  <div class=\"col-sm-4 \"><button type=\"submit\" class=\"btn btn-primary\">Add New</button></div>\n");
      out.write("                                                  <div class=\"col-sm-4 \"></div>\n");
      out.write("                                                </div>                                           \n");
      out.write("                                            </form>\n");
      out.write("                                        </div>\n");
...
String sql ="INSERT INTO room VALUES('"+roomId+"','"+roomType+"','"+beddingType+"')";
