...
public final class Change_005freception_005fpassword_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs = null;
      ...
      out.write("         <link rel=\"stylesheet\" type=\"text/css\" href=\"css/change_reception_password_style.css\">\n");
      ...
      out.write("        <ul class=\"col-sm-12 text-white\">\n");
      out.write("             <li><a  href=\"reception_profile.jsp\"><i class=\"fa fa-hotel ficon\"></i>Room Status</a></li>\n");
      out.write("            <li><a  href=\"reception_payments.jsp\"><i class=\"fas fa-money-check-alt ficon\"></i>View Payments</a></li>\n");
      out.write("            <li><a class=\"active\" href=\"Change_reception_password.jsp\"><i class=\"fa fa-wrench ficon\"></i>Change Password</a></li>\n");
      out.write("            <li><a href=\"logout.jsp\"><i class=\"fas fa-sign-out-alt ficon\"></i>Logout</a></li>\n");
      out.write("       </ul>\n");
      out.write("      </div>\n");
      out.write("     ");
  
    
 if (session == null || session.getAttribute("first_name") == null) {
      ...
      out.write("                                            </br>               \n");
      out.write("                                                <form action=\"Change_reception_password.jsp\" method=\"POST\">                   \n");
     ...
     try{
            ...
            rs = connection.createStatement().executeQuery("select password from user where username='"+session.getAttribute("userid")+"' " );
        
          if(newp.equals(pswrd) && uname.equals(session.getAttribute("username"))){
                 statement.execute("UPDATE user SET password ='"+newp+"' WHERE userid ='"+session.getAttribute("userid")+"'"); 
   
         }else{
   
      out.write("\n");
      out.write("              <script class=\"alert alert-danger\">\n");
      out.write("            alert(\"Username or Password does not match..!\");\n");
      out.write("                </script>\n");
      out.write("    ");
