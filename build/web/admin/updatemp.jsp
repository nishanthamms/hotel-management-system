  ...
  <section class="intro">
     <div class="row about">
             ...
             <div  id="emp" class="collapse show " >
                 <ul style="padding-left: 30px;">
                    ...
                    <li><a   href="addemployee.jsp"><i class="fas fa-plus-circle ficon"></i>Add Employee</a></li>
                     <li><a class="active" href="updatemp.jsp"><i class="fa fa-edit ficon"></i>Update Employee</a></li>
        ...
        <div class="col-md-9 col-sm-12 right bothpadding">
            <div class="container">
                <div class="col-12 col-md-12 col-lg-12 text-center"> <h1 class="page-header">UPDATE  <small class="small-header">EMPLOYEE</small></h1></div>   
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="container" style="background-color: white;">         
                              </br>   
                                   <div style=" border: 1px solid #428BCA;">
                                    <h4 class="text-white roomhead">Update Employee</h4>
                                     </br>
                ...
                ResultSet rs = stmt.executeQuery(sql);
                                            ...
                                            <form action="updatemp.jsp" method="POST">
     ...
     try{      
                 Statement stmt = new DB.DbConnection().getConnection().createStatement(); 
                 String query= "UPDATE user SET " + chead +"= '"+newValue+"' WHERE userid ='"+userId+"' "; 
