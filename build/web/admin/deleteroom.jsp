     ...
     <div class="col-md-3 col-sm-12 left bothpadding">     
           ...
           <li><a  class="d-flex "data-toggle="collapse" href="#" data-target="#demo"><i class="fa fa-hotel ficon"></i>Rooms<i class="fa fa-angle-down" style="padding-left: 140px"></i></a></li>
             <div  id="demo" class="collapse  show">
                 <ul style="padding-left: 30px;">
                    ...
                    <li><a   class="active" href="deleteroom.jsp"><i class="fas fa-trash-alt ficon"></i>Delete Room</a></li>
                 </ul>
             </div>
       ...
       <div class="col-md-9 col-sm-12 right bothpadding">
            <div class="container" style="padding-bottom: 200px;">
                <div class="col-12 col-md-12 col-lg-12 text-center"> <h1 class="page-header">DELETE  <small class="small-header">ROOM</small></h1></div>                    
                   <div class="row">
                       <div class="col-12 text-center">
                          <div class="container" style="background-color: white;">           
                           </br>          
                              <div style=" border: 1px solid #428BCA;">
                                <h4 class="text-white roomhead">Delete Room</h4>
                                  </br>               
                                   <form action="deleteroom.jsp" method="POST">                  
                                      <div class="form-group formtext">  
                                        <label class="font-weight-bold" for="roomid">Enter the Room Id:</label>
                                        <input type="text" class="form-control"  name="roomid">
                                      </div>                                                                                 
                                        </br>
                                        <div class="row">
                                         <div class="col-sm-4 "></div>
                                         <div class="col-sm-4 "><button type="submit" class="btn btn-primary">Delete Room</button></div>
                                         <div class="col-sm-4 "></div>
                                       </div>
                                       </br>                        
                                    </form>
