...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/change_user_password_style.css">
...
<section class="intro">
  ...
  <div class="row">       
      <div class="col-md-3 col-sm-12 left bothpadding">    
        <ul class="col-sm-12">
              <li><a   href="user_profile.jsp"><i class="fas fa-money-check-alt ficon"></i>View Payments</a></li>
              <li><a  class="active" href="Change_User_password"><i class="fa fa-wrench ficon"></i>Change Password</a></li>
              <li>
                                 ...
                                 <div class="container" style="background-color: white;">          
                                        ...
                                        <div style=" border: 1px solid #428BCA;">
                                            <h4 class="text-white roomhead">Change Password</h4>
                                                    ...
                                                    <form action="Change_User_password.jsp" method="POST">                   
