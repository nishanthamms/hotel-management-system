...
<html>
    <head>
        ...
        <title>delete registered employee</title>
    </head>
<body>
<section class="intro">
  <div class="row about"> 
       ...
       <ul class="col-sm-12 ">
           ...
           <li><a class="d-flex " data-toggle="collapse" href="#" data-target="#emp"><i class="fa fa-users ficon"></i>Employees<i class="fa fa-angle-down" style="padding-left: 110px"></i></a></li>
             <div  id="emp" class="collapse show" >
                 <ul style="padding-left: 30px;">
                    ...
                    <li><a class="active" href="delete_employee.jsp"><i class="fas fa-trash-alt ficon"></i>Delete Employee</a></li>
                   </ul>
             </div>
         ...
         <div class="col-md-9 col-sm-12 right bothpadding">
            <div class="container" style="padding-bottom: 200px;">
               <div class="col-12 col-md-12 col-lg-12 text-center"> <h1 class="page-header">DELETE  <small class="small-header">EMPLOYEE</small></h1></div>                    
                 <div class="row">
                    <div class="col-12 text-center">
                        <div class="container" style="background-color: white;">         
                          </br>       
                            <div style=" border: 1px solid #428BCA;">
                                <h4 class="text-white roomhead">Delete Employee</h4>
                                    </br>                                        
                                           <form action="delete_employee.jsp" method="POST">                    
                                               <div class="form-group formtext">  
                                                <label class="font-weight-bold" for="emid">Enter the Employee Id:</label>
                                                <input type="text" class="form-control"  name="empid">
                                                </div>                                                                                                          
                                            </br>
                                                <div class="row">
                                                 <div class="col-sm-4 "></div>
                                                 <div class="col-sm-4 "><button type="submit" class="btn btn-primary">Delete Employee</button></div>
                                                 <div class="col-sm-4 "></div>
                                               </div>
                                            </br>                        
                                            </form>
