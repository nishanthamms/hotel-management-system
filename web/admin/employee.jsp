...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../admin/css/home_style.css">
    ...
    <div class="col-md-3 col-sm-12 left bothpadding">     
         <ul class="col-sm-12 ">
           ...
           <li><a class="d-flex " data-toggle="collapse" href="#" data-target="#emp"><i class="fa fa-users ficon"></i>Employees<i class="fa fa-angle-down" style="padding-left: 110px"></i></a></li>
             <div  id="emp" class="collapse show " >
                 <ul style="padding-left: 30px;">
                    <li><a  class="active"   href="employee.jsp"><i class="fas fa-info-circle ficon"></i>Employee Details</a></li>
       ...
       <div class="col-md-9 col-sm-12 right bothpadding">
           <div class="container "style="padding-bottom: 200px;">
               <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center"> <h1 class="page-header"> EMPLOYEE  <small class="small-header">DETAILS</small></h1></div>                     
                  <div class="row">
                     <div class="col-12 text-center">
                         <div class="container" style="background-color: white;">           
                           </br>          
                             <div style=" border: 1px solid #428BCA;">
                                <h4 class="text-white roomhead">Employee Details</h4>
                                                ...
                                                <th>Password</th>
                                                        ...
                                                        %>
                                                             ...
                                                             <tr>
                                                               ...
                                                               <td><%out.println(resultSet.getString("first_name"));%></td>
                                                               <td><%out.println(resultSet.getString("Last_name"));%></td>
                                                               <td><%out.println(resultSet.getString("gender"));%></td>
                                                               <td><%out.println(resultSet.getString("address"));%></td>
                                                               <td><%out.println(resultSet.getString("email"));%></td>
                                                               <td><%out.println(resultSet.getString("phone"));%></td>
