...
<div class="row">      
        ...
        <ul class="col-sm-12 ">
           ...
           <li><a class="d-flex " data-toggle="collapse" href="#" data-target="#pay"><i class="fas fa-money-check-alt ficon"></i>Payments<i class="fa fa-angle-down" style="padding-left: 118px"></i></a></li>
             <div  id="pay" class="collapse show">
                 <ul style="padding-left: 30px;">
                    <li><a  class="active"  href="payments.jsp"><i class="fas fa-info-circle ficon"></i>Payment Details</a></li>
    ...
    <div class="col-md-9 col-sm-12 right bothpadding">
        <div class="container" style="padding-bottom: 200px;">
            <div class="col-12 col-md-12 col-sm-12 col-lg-12 text-center"> <h1 class="page-header">PAYMENT <small class="small-header">DETAILS</small></h1></div>                    
                <div class="row">
                        ...
                        <div class="container" style="background-color: white;">            
                            ...
                            <div style=" border: 1px solid #428BCA;">
                                <h4 class="text-white roomhead">Payment Details</h4>
                                        ...
                                        <table class="table  table-responsive-md  table-responsive table-hover">
